...
public class Question10 extends JPanel {
	Methods methods = new Methods();
	
    private String WORD = "USER"; // The word to guess
    ...
    public Question10(Main frame) {
    	this.frame = frame;
    	
    	JLabel lblTitle = new JLabel("Question #10");
        ...
        // Question Label
        JLabel lblQuestion = new JLabel("<html>What is the fundamental aspect of user-centered design?</html>");
    ...
    private void checkGameOver() {
        ...
        JOptionPane.showMessageDialog(null, "Congratulations!", "Notice!", JOptionPane.INFORMATION_MESSAGE);
        System.exit(0);
        }
    }
