...
public class Question4 extends JPanel {
    ...
    private String WORD = "USABILITY"; // The word to guess
    ...
    public Question4(Main frame) {
    	this.frame = frame;
    	
    	JLabel lblTitle = new JLabel("Question #4");
        ...
        // Question Label
        JLabel lblQuestion = new JLabel("<html>What is the primary focus of HCI when designing user interfaces?</html>");
        lblQuestion.setFont(new Font("Segoe UI", Font.ITALIC, 24));
        lblQuestion.setHorizontalAlignment(SwingConstants.CENTER);
        lblQuestion.setBounds(74, 146, 373, 72);
        add(lblQuestion);
    ...
    private void checkGameOver() {
        if (guessedWord.toString().equals(WORD)) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "Proceed to Question 5?", "Notice", JOptionPane.YES_NO_OPTION);
            if(choice == JOptionPane.YES_OPTION) {
            	methods.switchPanels(frame, this, frame.question5Panel);
            }
        }
    }
