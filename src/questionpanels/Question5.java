...
public class Question5 extends JPanel {
    ...
    public Question5(Main frame) {
    	this.frame = frame;
    	
    	JLabel lblTitle = new JLabel("Question #5");
    ...
    private void checkGameOver() {
        if (guessedWord.toString().equals(WORD)) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "Proceed to Question 6?", "Notice", JOptionPane.YES_NO_OPTION);
            if(choice == JOptionPane.YES_OPTION) {
            	methods.switchPanels(frame, this, frame.question6Panel);
            }
        }
    }
