...
public class Question7 extends JPanel {
    ...
    private String WORD = "SAFETY"; // The word to guess
    ...
    public Question7(Main frame) {
    	this.frame = frame;
    	
    	JLabel lblTitle = new JLabel("Question #7");
        ...
        // Question Label
        JLabel lblQuestion = new JLabel("<html>What design principle focuses on minimizing user error?</html>");
        lblQuestion.setFont(new Font("Segoe UI", Font.ITALIC, 24));
        lblQuestion.setHorizontalAlignment(SwingConstants.CENTER);
        lblQuestion.setBounds(46, 146, 401, 74);
        add(lblQuestion);
    ...
    private void checkGameOver() {
        if (guessedWord.toString().equals(WORD)) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "Proceed to Question 8?", "Notice", JOptionPane.YES_NO_OPTION);
            if(choice == JOptionPane.YES_OPTION) {
            	methods.switchPanels(frame, this, frame.question8Panel);
            }
        }
    }
