...
public class Question2 extends JPanel {
    ...
    private String WORD = "OPTIMIZATION"; // The word to guess
    ...
    public Question2(Main frame) {
    	this.frame = frame;
    	
    	JLabel lblTitle = new JLabel("Question #2");
        ...
        // Question Label
        JLabel lblQuestion = new JLabel("<html>What is the process of improving the performance of a system called?</html>");
    ...
    private void checkGameOver() {
        if (guessedWord.toString().equals(WORD)) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "Proceed to Question 3?", "Notice", JOptionPane.YES_NO_OPTION);
            if(choice == JOptionPane.YES_OPTION) {
            	methods.switchPanels(frame, this, frame.question3Panel);
            }
        }
    }
