...
public class Question3 extends JPanel {
    ...
    private void checkGameOver() {
        if (guessedWord.toString().equals(WORD)) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "Proceed to Question 4?", "Notice", JOptionPane.YES_NO_OPTION);
            if(choice == JOptionPane.YES_OPTION) {
            	methods.switchPanels(frame, this, frame.question4Panel);
            }
        }
    }
